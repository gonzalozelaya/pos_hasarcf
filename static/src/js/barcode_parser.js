odoo.define('pos_hasarcf/static/src/js/barcode_parser.js', function (require) {
"use strict";
...
//    },
    ...
    /**
     * @override
     * @returns {match_pattern} If there is modifications Log, returns an array or null
     */
...
//        }
        ...
        return this._super(barcode, pattern, encoding);
//        return this._super(...arguments);
    },
